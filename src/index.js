...
.dp-brand{display:inline-flex;align-items:center;gap:10px;text-decoration:none;color:#0f172a;font-size:19px;font-weight:900;letter-spacing:-.02em;white-space:nowrap}
.dp-logo{width:30px;height:30px;display:block;flex:0 0 30px}
.dp-accent{color:#2563eb}
.dp-header{border-bottom:1px solid #dbe4ef;background:rgba(255,255,255,.96);backdrop-filter:blur(10px)}
.dp-nav{min-height:70px;display:flex;align-items:center;justify-content:space-between;gap:24px}
.dp-navlinks{display:flex;align-items:center;gap:24px;font-size:12px;font-weight:800}
.dp-navlinks a{text-decoration:none;color:#0f172a}
.dp-navlinks a:hover{color:#2563eb}
.dp-cta{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:11px;padding:12px 17px;background:#0f172a;color:#fff!important;text-decoration:none;font-weight:850;box-shadow:0 8px 24px rgba(15,23,42,.12)}
.dp-cta:hover{transform:translateY(-1px)}
@media(max-width:760px){.dp-navlinks{display:none}.dp-nav{min-height:62px}.dp-logo{width:27px;height:27px}.dp-brand{font-size:17px}}


.hero h1{max-width:920px;text-wrap:balance}
.hero .lead{max-width:820px}
.section .copy{font-size:16px;line-height:1.72;color:#475569}
.cards article{background:#fff}
...
<section class="product-section" id="tools" style="background:#fbfcfe;border-top:1px solid #eef2f7;border-bottom:1px solid #eef2f7">
  <div class="wrap">
    ...
    <div class="toolgrid">
      ...
      <a class="toolcard" href="/deployment-security-check"><div class="toolicon">D</div><h3>Deployment Security Check</h3><p>Run a practical pre-deployment security check before launch and review the public risks that matter first.</p><span class="toolgo">Check before deployment →</span></a>
...
<body>
<header class="dp-header"><div class="wrap dp-nav"><a class="dp-brand" href="/" aria-label="DeployPass home"><svg class="dp-logo" viewBox="0 0 64 64" aria-hidden="true">
<defs><linearGradient id="dpGrad" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
<rect width="64" height="64" rx="16" fill="url(#dpGrad)"/>
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a>
<nav class="dp-navlinks"><a href="/#tools">Tools</a><a href="/website-vulnerability-scanner">Vulnerability scan</a><a href="/deployment-security-check">Deployment check</a><a href="/#checks">What we check</a><a href="/#faq">FAQ</a></nav>
<a class="dp-cta" href="/#scanner">Run full scan →</a></div></header>
...
<footer><div class="wrap foot"><a class="dp-brand" href="/" aria-label="DeployPass home"><svg class="dp-logo" viewBox="0 0 64 64" aria-hidden="true">
<defs><linearGradient id="dpGrad" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
<rect width="64" height="64" rx="16" fill="url(#dpGrad)"/>
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a><span>© 2026 DeployPass · Public-surface deployment security checks.</span><a href="/">Full 19-check scanner →</a></div></footer>
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/health") {
      return json({ok:true, service:"deploypass", version:"scanner-v5.3"});
    }
...
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a><span>© 2026 DeployPass · Public-surface deployment security checks.</span><a href="/security-headers-checker">Security Headers Checker →</a></div></footer>
<script>
const esc=s=>String(s==null?'':s).replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    <loc>https://deploypass.com/deployment-security-check</loc>
    <changefreq>weekly</changefreq>
...
const DEPLOYMENT_SECURITY_HTML = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Deployment Security Check — Free Website Test | DeployPass</title><meta name="description" content="Run a free deployment security check before launch. Review security headers, CORS, cookies, mixed content, frontend exposure and other public deployment risks."><meta name="robots" content="index,follow"><link rel="canonical" href="https://deploypass.com/deployment-security-check"><meta property="og:type" content="website"><meta property="og:site_name" content="DeployPass"><meta property="og:title" content="Deployment Security Check — Free Website Test"><meta property="og:description" content="Run 19 passive pre-deployment security checks before you ship a public website or app."><meta property="og:url" content="https://deploypass.com/deployment-security-check"><meta property="og:image" content="https://deploypass.com/og-image.png"><meta name="twitter:card" content="summary_large_image"><style>${FOCUSED_CSS}
.dp-brand{display:inline-flex;align-items:center;gap:10px;text-decoration:none;color:#0f172a;font-size:19px;font-weight:900;letter-spacing:-.02em;white-space:nowrap}
.dp-logo{width:30px;height:30px;display:block;flex:0 0 30px}
.dp-accent{color:#2563eb}
.dp-header{border-bottom:1px solid #dbe4ef;background:rgba(255,255,255,.96);backdrop-filter:blur(10px)}
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"SoftwareApplication","name":"DeployPass Deployment Security Check","applicationCategory":"SecurityApplication","operatingSystem":"Web","url":"https://deploypass.com/deployment-security-check","description":"A free passive pre-deployment security check for public websites and web applications.","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"DeployPass","item":"https://deploypass.com/"},{"@type":"ListItem","position":2,"name":"Deployment Security Check","item":"https://deploypass.com/deployment-security-check"}]}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is a deployment security check?","acceptedAnswer":{"@type":"Answer","text":"A deployment security check is a review performed before or around a production release to catch security misconfigurations and public exposure that should be fixed before users reach the application."}},{"@type":"Question","name":"What security checks should I run before deployment?","acceptedAnswer":{"@type":"Answer","text":"Start with HTTPS and security headers, CORS, cookie posture, mixed content, frontend exposure, source maps and obvious deployment information leakage. Add application-specific authentication and authorization testing where appropriate."}},{"@type":"Question","name":"Can I use this as a deployment security checklist?","acceptedAnswer":{"@type":"Answer","text":"Yes. DeployPass covers 19 passive public-surface checks and provides a practical release review, but it should be one layer of a broader secure deployment process."}},{"@type":"Question","name":"Is this a penetration test?","acceptedAnswer":{"@type":"Answer","text":"No. DeployPass performs passive public checks and does not attempt exploitation, credential attacks, brute force or port scanning."}},{"@type":"Question","name":"Should I scan staging or production?","acceptedAnswer":{"@type":"Answer","text":"Scan a publicly reachable environment you are authorized to review. A production-like staging environment is useful before launch, followed by a production re-check after deployment."}}]}</script></head><body>
<header class="dp-header"><div class="wrap dp-nav"><a class="dp-brand" href="/" aria-label="DeployPass home"><svg class="dp-logo" viewBox="0 0 64 64" aria-hidden="true">
<defs><linearGradient id="dpGrad" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
<rect width="64" height="64" rx="16" fill="url(#dpGrad)"/>
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
...
<nav class="dp-navlinks"><a href="/#tools">Tools</a><a href="/website-vulnerability-scanner">Vulnerability scan</a><a href="/deployment-security-check">Deployment check</a><a href="/#checks">What we check</a><a href="/#faq">FAQ</a></nav>
<a class="dp-cta" href="/#scanner">Run full scan →</a></div></header>
<main><section class="hero"><div class="wrap"><div class="crumb"><a href="/">DeployPass</a> / Deployment Security Check</div><div class="pill">Free · No signup · 19 passive checks</div><h1>Deployment Security Check<br>Before You Ship</h1><p class="lead">Run a practical pre-deployment security check on a public website or app before launch. DeployPass reviews security headers, CORS, cookies, mixed content, frontend exposure and other observable deployment risks—without exploit attempts.</p><form class="form" id="dForm"><input id="dUrl" type="text" placeholder="Enter a public staging or production URL" required><button class="btn" id="dBtn">Run deployment check →</button></form><p class="micro">Public-surface checks only. No login, brute force, port scan or credential testing.</p><div class="status" id="dStatus" style="display:none"></div></div></section>
<section class="results" id="dResults" style="display:none"><div class="wrap resultgrid"><aside class="scorebox"><div class="label">DEPLOYMENT SCORE</div><div class="big"><span id="dScore">—</span><small>/100</small></div><div class="badge review" id="dVerdict">REVIEW</div></aside><div class="panel"><h2>Pre-deployment review</h2><p id="dTarget"></p><div id="dChecks"></div></div></div></section>
<section class="section"><div class="wrap"><div class="eyebrow">PRE-DEPLOYMENT SECURITY CHECKLIST</div><h2>What to check before deployment.</h2><p class="copy">A deployment security check should focus first on mistakes that become public the moment a build ships. A useful security checklist before deployment combines transport protection, browser security controls, cross-origin behavior, cookie settings and accidental frontend exposure. DeployPass turns those observable signals into a short review you can run before production and repeat after a fix.</p><div class="cards"><article><h3>1. Security headers</h3><p>Review Content-Security-Policy, HSTS, X-Content-Type-Options, clickjacking controls and Referrer-Policy. Missing headers are not automatically vulnerabilities, but they can remove useful browser defenses or reveal that production hardening was skipped. Treat each result in the context of the application, then verify the final response after deployment.</p></article><article><h3>2. CORS & browser policy</h3><p>Check cross-origin response behavior and Permissions-Policy for unexpectedly broad access. Public APIs may intentionally allow multiple origins, while authenticated endpoints usually need tighter rules. Pay special attention when credentials and broad origins appear together, and confirm that browser feature permissions match what the product actually needs.</p></article><article><h3>3. Cookies & HTTPS</h3><p>Confirm the final page uses HTTPS and review Secure, HttpOnly and SameSite cookie signals. Also look for HTTP resources referenced by an HTTPS document. Mixed content can weaken transport guarantees, create browser warnings or cause active resources to be blocked after a release.</p></article><article><h3>4. Frontend exposure</h3><p>Review public environment hints, source maps, debug markers and client-visible deployment details. Frontend code is public by nature, so the goal is not to hide ordinary JavaScript. The goal is to avoid shipping secrets, internal endpoints, unnecessary debugging information or configuration that should never have reached a public build.</p></article><article><h3>5. Public response hygiene</h3><p>Inspect server and framework disclosure, response headers and scan coverage. Version banners are rarely a vulnerability on their own, but unnecessary disclosure can help fingerprint a stack. A pre-deployment security check is most useful when it highlights these low-cost hardening opportunities before they become permanent production defaults.</p></article><article><h3>6. Re-scan after fixes</h3><p>Security review should be repeatable. Fix high-signal findings, deploy the change and run the same check again. A re-scan confirms that the public response actually changed and helps catch regressions introduced by proxies, hosting configuration, CDN rules or a production-only environment.</p></article></div></div></section>
<section class="section alt"><div class="wrap"><div class="eyebrow">WHY RUN IT BEFORE RELEASE</div><h2>Use a pre-deployment security check as a release gate.</h2><p class="copy">A production release changes what the internet can observe. Headers may differ behind a CDN, cookies can gain different attributes, environment variables can be bundled into frontend assets, and a staging-only configuration can accidentally become public. Running a pre-deployment security check creates a simple checkpoint between “the build works” and “the build is ready to ship.”</p><p class="copy">For small teams, indie makers and AI-assisted development workflows, this matters because infrastructure decisions are often spread across application code, hosting dashboards and edge configuration. A developer may correctly configure a framework while a proxy strips the header later. The most useful check therefore looks at the public response rather than only reviewing source code.</p><p class="copy">DeployPass is designed for that final public-surface review. It does not log in or attack the target. Instead, it checks what a normal visitor can observe and gives you a practical list of items to review before launch.</p></div></section>
<section class="section"><div class="wrap"><div class="eyebrow">A PRACTICAL RELEASE WORKFLOW</div><h2>How to run a security check before deployment.</h2><div class="cards"><article><h3>1. Use a production-like URL</h3><p>Start with a staging, preview or production URL that is publicly reachable and that you are authorized to test. A production-like environment gives more useful results because CDN, proxy, TLS and hosting behavior can differ from localhost.</p></article><article><h3>2. Review high-signal findings first</h3><p>Prioritize transport problems, unsafe cross-origin combinations, missing protections that matter to your application, insecure cookies and exposed deployment information. Do not chase a perfect score simply because a header can be added.</p></article><article><h3>3. Fix configuration at the right layer</h3><p>A finding may belong in application middleware, a hosting configuration file, a reverse proxy or a CDN rule. Make the smallest change that matches the intended behavior, then test the application rather than blindly copying a strict policy.</p></article><article><h3>4. Re-run the public check</h3><p>After deployment, scan the final public URL again. This confirms that the browser-facing response contains the intended change. It also catches cases where a platform overrides or removes a setting between your code and the user.</p></article></div></div></section>
<section class="section alt"><div class="wrap"><div class="eyebrow">DEPLOYMENT SECURITY</div><h2>A pre-deployment check is not a penetration test.</h2><p class="copy">This page is designed for developers and teams that want a fast website security test before deployment. Passive scanning can identify browser-facing misconfiguration and accidental public exposure, but it cannot prove an application is vulnerability-free. Authentication flaws, authorization bugs, business-logic issues, database weaknesses and server-side vulnerabilities may require authenticated testing, code review or a professional penetration test.</p><p class="copy">That distinction is important when interpreting a clean result. A high DeployPass score means the observable checks performed here did not reveal many problems; it does not certify the application as secure. Use the result as a release-quality signal and a starting point for deeper security work where the risk justifies it.</p><p class="copy">If you want a broader public-facing scan framed around vulnerability discovery, use the <a href="/website-vulnerability-scanner">Website Vulnerability Scanner</a>. For a single control, use the <a href="/security-headers-checker">Security Headers Checker</a>, <a href="/csp-checker">CSP Checker</a>, <a href="/cors-checker">CORS Checker</a>, <a href="/mixed-content-checker">Mixed Content Checker</a> or <a href="/permissions-policy-checker">Permissions Policy Checker</a>.</p></div></section>
<section class="section"><div class="wrap faq" id="faq"><div class="eyebrow">FAQ</div><h2>Deployment security check FAQ</h2><details open><summary>What is a deployment security check?</summary><p>A deployment security check is a review performed before or around a production release to catch security misconfigurations and public exposure before users reach the application. It can include HTTPS, browser security headers, CORS, cookies, mixed content and frontend deployment signals. DeployPass focuses on passive checks that can be observed from a public URL.</p></details><details><summary>What security checks should I run before deployment?</summary><p>Start with HTTPS and security headers, then review CORS, cookie attributes, mixed content, browser permissions, source maps, debug information and obvious environment leakage. For applications with accounts or sensitive data, add authentication, authorization, dependency, server-side and business-logic testing appropriate to the product.</p></details><details><summary>Can I use this as a deployment security checklist?</summary><p>Yes. The 19 passive checks and the checklist on this page provide a practical baseline for a public web release. Use it as a repeatable release gate rather than a compliance certificate. Teams with higher-risk applications should extend the checklist with code review, dependency scanning and authenticated security testing.</p></details><details><summary>Is this a penetration test?</summary><p>No. DeployPass performs passive public checks and does not attempt exploitation, credential attacks, brute force or port scanning. A penetration test is deeper and may actively probe application behavior, authentication, authorization and server-side weaknesses with explicit authorization.</p></details><details><summary>Should I scan staging or production?</summary><p>Scan a publicly reachable environment you are authorized to review. A production-like staging environment is useful before launch because it can reveal configuration mistakes early. Re-scan the production URL after release because CDN, proxy, TLS and environment behavior can change between staging and production.</p></details></div></section></main>
<footer><div class="wrap foot"><a class="dp-brand" href="/" aria-label="DeployPass home"><svg class="dp-logo" viewBox="0 0 64 64" aria-hidden="true">
<defs><linearGradient id="dpGrad" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
<rect width="64" height="64" rx="16" fill="url(#dpGrad)"/>
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a><span>© 2026 DeployPass · Public-surface deployment security checks.</span><span><a href="/website-vulnerability-scanner">Vulnerability Scanner</a> · <a href="/">Full scan →</a></span></div></footer>
<script>const escD=s=>String(s??'').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));document.getElementById('dForm').addEventListener('submit',async e=>{e.preventDefault();const b=document.getElementById('dBtn'),st=document.getElementById('dStatus');b.disabled=true;b.textContent='Checking…';st.style.display='block';st.textContent='Running 19 pre-deployment security checks…';try{const r=await fetch('/api/scan',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({url:document.getElementById('dUrl').value})});const d=await r.json();if(!r.ok)throw new Error(d.error||'Check failed');document.getElementById('dResults').style.display='block';document.getElementById('dScore').textContent=d.score??'—';document.getElementById('dVerdict').textContent=d.verdict||'REVIEW';document.getElementById('dTarget').textContent='Checked '+(d.finalUrl||d.url||document.getElementById('dUrl').value);const checks=Array.isArray(d.checks)?d.checks:[];document.getElementById('dChecks').innerHTML=checks.map(x=>'<div class="finding"><div><b>'+escD(x.title||x.name||'Security check')+'</b><p>'+escD(x.message||x.summary||x.detail||x.status||'Check complete')+'</p></div></div>').join('')||'<div class="finding"><div><b>Deployment check complete</b><p>Use the full scan for the detailed report.</p></div></div>';st.textContent='Deployment security check complete.';document.getElementById('dResults').scrollIntoView({behavior:'smooth'});}catch(x){st.textContent=x.message||'Check failed.'}finally{b.disabled=false;b.textContent='Run deployment check →'}});</script></body></html>`;

const VULNERABILITY_HTML = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Free Website Vulnerability Scanner | DeployPass</title>
<meta name="description" content="Scan your website for security issues with a free vulnerability scanner. Check headers, HTTPS, cookies, CORS and deployment risks before launch.">
<meta name="robots" content="index,follow"><link rel="canonical" href="https://deploypass.com/website-vulnerability-scanner">
<meta property="og:type" content="website"><meta property="og:site_name" content="DeployPass"><meta property="og:title" content="Free Website Vulnerability Scanner | DeployPass"><meta property="og:description" content="Scan a public website for security misconfigurations and deployment risks with 19 passive checks."><meta property="og:url" content="https://deploypass.com/website-vulnerability-scanner">
<style>
...
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "SoftwareApplication", "name": "DeployPass Website Vulnerability Scanner", "applicationCategory": "SecurityApplication", "operatingSystem": "Web", "url": "https://deploypass.com/website-vulnerability-scanner", "description": "A free passive website vulnerability scanner for public-facing security misconfigurations and deployment risks.", "offers": {"@type": "Offer", "price": "0", "priceCurrency": "USD"}}</script>
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "DeployPass", "item": "https://deploypass.com/"}, {"@type": "ListItem", "position": 2, "name": "Website Vulnerability Scanner", "item": "https://deploypass.com/website-vulnerability-scanner"}]}</script>
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What can a website vulnerability scanner detect?", "acceptedAnswer": {"@type": "Answer", "text": "A passive website vulnerability scanner can identify security misconfigurations that are visible from a public URL, including missing browser security headers, weak cookie attributes, HTTPS and mixed-content issues, CORS exposure, browser policy gaps, and frontend information that should not be exposed. DeployPass focuses on observable deployment risks rather than attempting to exploit the target."}}, {"@type": "Question", "name": "Is this website vulnerability scanner free?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. DeployPass lets you run the public-surface website vulnerability scan without creating an account. Enter a public HTTP or HTTPS URL and review the findings. The scan is intended as a fast pre-deployment or post-deployment security review, not a replacement for a complete professional security assessment."}}, {"@type": "Question", "name": "Does a vulnerability scanner hack my website?", "acceptedAnswer": {"@type": "Answer", "text": "DeployPass does not attempt to break into the website. Its scanner uses passive and low-impact requests to inspect publicly observable responses and configuration signals. It does not perform SQL injection, password attacks, authenticated exploitation, destructive testing, or intrusive penetration-testing techniques."}}, {"@type": "Question", "name": "How often should I scan my website?", "acceptedAnswer": {"@type": "Answer", "text": "Run a scan before an important deployment and again after changes that affect hosting, headers, authentication, cookies, CDN rules, redirects, or frontend configuration. Rechecking after a fix is also useful because a change in the application, reverse proxy, CDN, or hosting platform can alter the security signals exposed to browsers."}}, {"@type": "Question", "name": "What is the difference between vulnerability scanning and penetration testing?", "acceptedAnswer": {"@type": "Answer", "text": "A scanner automates repeatable checks and quickly highlights known classes of configuration risk. Penetration testing is broader and usually involves a security professional actively testing application logic, authentication, authorization, infrastructure, and exploitability. DeployPass is intentionally on the safe, passive-scanning side of that distinction."}}, {"@type": "Question", "name": "Can I scan a staging website before deployment?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, if the staging URL is publicly reachable from the internet. Private localhost addresses, internal network hosts, and protected staging environments cannot be inspected by a public scanner. For a public preview deployment, scanning before production can catch browser-facing configuration problems early."}}, {"@type": "Question", "name": "Can this scanner find every website vulnerability?", "acceptedAnswer": {"@type": "Answer", "text": "No scanner can guarantee that. DeployPass does not claim to discover every application, server, dependency, or business-logic vulnerability. It is designed to surface common public-facing security and deployment issues quickly. High-risk applications should also use code review, dependency scanning, authenticated testing, and professional penetration testing where appropriate."}}, {"@type": "Question", "name": "What should I do after the scan finds a warning?", "acceptedAnswer": {"@type": "Answer", "text": "Read the finding and verify whether it applies to your application. Fix the relevant application, CDN, reverse-proxy, or hosting configuration, deploy the change, and scan again. Use the focused DeployPass checkers for headers, HSTS, CSP, CORS, mixed content, and Permissions Policy when you need a narrower diagnostic view."}}]}</script>
</head><body>
<header class="dp-header"><div class="wrap dp-nav"><a class="dp-brand" href="/" aria-label="DeployPass home"><svg class="dp-logo" viewBox="0 0 64 64" aria-hidden="true">
<defs><linearGradient id="dpGrad" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#2563eb"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
<rect width="64" height="64" rx="16" fill="url(#dpGrad)"/>
...
<nav class="dp-navlinks"><a href="/#tools">Tools</a><a href="/website-vulnerability-scanner">Vulnerability scan</a><a href="/deployment-security-check">Deployment check</a><a href="/#checks">What we check</a><a href="/#faq">FAQ</a></nav>
<a class="dp-cta" href="/#scanner">Run full scan →</a></div></header>
<section class="hero"><div class="wrap"><div class="crumb"><a href="/">DeployPass</a> / Website Vulnerability Scanner</div><span class="pill">FREE · PASSIVE · NO SIGNUP</span><h1>Free Website Vulnerability Scanner</h1><p class="lead">Scan your website for security issues with a free vulnerability scanner. Detect exposed configuration, missing browser protections, insecure resource loading and common deployment risks before launch — without exploitation, login attempts or intrusive testing.</p><form class="form" id="vForm"><input id="vUrl" type="url" placeholder="https://example.com" required><button class="btn" id="vBtn" type="submit">Scan website →</button></form><p class="micro">Public HTTP/HTTPS URLs only. DeployPass performs passive public-surface checks.</p><div class="status" id="vStatus">Ready to scan.</div></div></section>
<section class="results" id="vResults" style="display:none"><div class="wrap"><div class="resultgrid"><div class="scorebox"><div class="label">VULNERABILITY REVIEW</div><div class="big"><span id="vScore">—</span><small>/100</small></div><span class="badge" id="vBadge">—</span></div><div class="panel"><h2>Public-surface findings</h2><p id="vSummary"></p><div id="vFindings"></div></div></div></div></section>

<section class="section"><div class="wrap"><span class="eyebrow">UNDERSTAND THE TOOL</span><h2>What is a website vulnerability scanner?</h2>
<p class="copy">A website vulnerability scanner helps identify security weaknesses that may be visible when a website or web application is accessed from the internet. Some scanners actively probe an application for exploitable flaws. DeployPass takes a narrower approach: it reviews public, browser-facing security signals and deployment configuration without attempting to exploit the target.</p>
<p class="copy">That makes the scanner useful as a fast security check before launch, after a deployment, or when configuration changes move through a CDN, reverse proxy or hosting platform. A page can work perfectly for users while still missing protections such as Content Security Policy, HSTS, secure cookie attributes or sensible cross-origin rules. Those issues are easy to overlook because they often live outside the application code itself.</p>
<p class="copy">DeployPass turns those observable signals into a practical report. It is designed for developers who want to scan a website for vulnerabilities and configuration risks quickly, understand why a finding matters, and then verify the fix. It is not a promise that a website is vulnerability-free, and it should complement — not replace — code review, dependency scanning and deeper security testing for high-risk applications.</p></div></section>

<section class="section alt"><div class="wrap"><span class="eyebrow">19 PASSIVE CHECKS</span><h2>What does the DeployPass website vulnerability scanner check?</h2><p class="copy">The scan groups public-facing signals into areas that commonly change during deployment. Each category answers a different question about how the site is exposed to browsers and other origins.</p>
<div class="cards">
<article><h3>Security headers</h3><p>Checks browser protections such as Content-Security-Policy, Strict-Transport-Security, X-Content-Type-Options, Referrer-Policy and related headers. Missing headers are not automatically proof of exploitation, but they can remove useful layers of defense and often indicate deployment configuration that deserves review.</p></article>
<article><h3>HTTPS & mixed content</h3><p>Reviews HTTPS-facing behavior and looks for insecure HTTP resources referenced from secure pages. Mixed content can weaken transport guarantees and create browser warnings or blocked resources. The goal is to catch issues introduced by old asset URLs, redirects, proxies or deployment-specific configuration.</p></article>
<article><h3>Cookie security</h3><p>Reviews observable Set-Cookie attributes such as Secure, HttpOnly and SameSite. These attributes help constrain when browsers send cookies and whether client-side scripts can access them. The correct policy depends on how your application authenticates users and whether cross-site flows are intentional.</p></article>
<article><h3>CORS configuration</h3><p>Inspects cross-origin response signals, including Access-Control-Allow-Origin and credential-related behavior. CORS is context dependent: allowing another origin is not inherently a vulnerability. DeployPass highlights combinations that deserve review rather than treating every permissive-looking header as a confirmed exploit.</p></article>
<article><h3>Frontend exposure</h3><p>Looks for publicly observable frontend signals that may reveal unnecessary implementation detail, debug artifacts or deployment information. Client-side code is inherently public, so the objective is not to label normal JavaScript as a secret; it is to identify exposure patterns worth checking before production.</p></article>
<article><h3>Browser security policies</h3><p>Reviews policies such as Permissions-Policy and other browser-facing controls that limit access to powerful features. These policies can reduce unnecessary capability and make application intent clearer. DeployPass reports missing or broad policies as review items when appropriate, not as automatic proof of compromise.</p></article>
</div></div></section>

<section class="section"><div class="wrap"><span class="eyebrow">KNOW THE LIMITS</span><h2>Website vulnerability scanner vs. penetration test</h2>
<p class="copy">Automated vulnerability scanning and penetration testing solve different problems. A scanner is fast, repeatable and useful for catching known classes of security or configuration issues. A penetration test goes deeper: a security professional may examine authentication, authorization, application logic, infrastructure and whether weaknesses can actually be chained or exploited.</p>
<div class="cards"><article><h3>DeployPass passive scan</h3><p>Automated, repeatable and low impact. Best for quick public-surface checks before or after deployment. It does not log in, brute-force accounts, inject attack payloads, scan private networks or attempt to prove exploitability.</p></article><article><h3>Penetration testing</h3><p>Broader and more contextual. It may include authenticated testing, business-logic review, exploit validation and manual investigation. Applications handling sensitive data or important business processes should consider professional testing in addition to automated checks.</p></article></div>
<p class="copy">In practical terms, use DeployPass as an early warning system and deployment gate. If it flags a missing control, fix it and rescan. If your threat model requires assurance against SQL injection, authorization flaws, server vulnerabilities, dependency CVEs or complex attack chains, use security tooling designed for those areas as well.</p></div></section>

<section class="section alt"><div class="wrap"><span class="eyebrow">FOUR STEPS</span><h2>How to scan a website for vulnerabilities</h2><div class="cards">
<article><h3>1. Enter the website URL</h3><p>Use a public HTTP or HTTPS address that the scanner can reach. A production site, public preview deployment or internet-accessible staging environment can be checked. Private localhost and internal-only hosts are intentionally excluded.</p></article>
<article><h3>2. Run passive security checks</h3><p>DeployPass requests the public site and analyzes observable response headers, browser policies and deployment signals. The scan is designed to be low impact and does not require credentials or installation on the target.</p></article>
<article><h3>3. Review the findings</h3><p>Use the score as a summary, then read individual findings. A warning is a prompt to investigate context, not proof that an attacker can compromise the site. Focus first on findings that affect the protections your application actually relies on.</p></article>
<article><h3>4. Fix and scan again</h3><p>Update the application, CDN, proxy or hosting configuration that controls the affected signal. Redeploy, rerun the scan and confirm that the expected response is now visible from the public internet.</p></article>
</div></div></section>

<section class="section"><div class="wrap"><span class="eyebrow">BUILT FOR SHIPPING</span><h2>Who should use a website vulnerability scanner?</h2>
<p class="copy">Developers can use it as a quick pre-deployment review when security headers and hosting configuration sit outside normal application tests. Indie hackers and small teams can add a lightweight check before shipping an MVP. Agencies can use a repeatable scan when handing off a site or validating a production deployment. Startups can use the report to catch browser-facing regressions while their infrastructure is changing quickly.</p>
<p class="copy">The scanner is especially useful when a site moves between platforms or adds a CDN, reverse proxy, authentication provider or new frontend integration. Those changes can modify headers, redirects, cookies and cross-origin behavior without obvious visual symptoms. Running the same check before and after deployment gives you a simple way to verify what the public site actually exposes.</p>
<p class="copy">For a launch-focused workflow, pair this page with the <a href="/deployment-security-check">Deployment Security Check</a>. For a narrower diagnosis, use the focused checkers below instead of rerunning a broad scan for every individual header.</p></div></section>

<section class="section alt"><div class="wrap faq"><span class="eyebrow">FAQ</span><h2>Website vulnerability scanner FAQ</h2><details><summary>What can a website vulnerability scanner detect?</summary><p>A passive website vulnerability scanner can identify security misconfigurations that are visible from a public URL, including missing browser security headers, weak cookie attributes, HTTPS and mixed-content issues, CORS exposure, browser policy gaps, and frontend information that should not be exposed. DeployPass focuses on observable deployment risks rather than attempting to exploit the target.</p></details><details><summary>Is this website vulnerability scanner free?</summary><p>Yes. DeployPass lets you run the public-surface website vulnerability scan without creating an account. Enter a public HTTP or HTTPS URL and review the findings. The scan is intended as a fast pre-deployment or post-deployment security review, not a replacement for a complete professional security assessment.</p></details><details><summary>Does a vulnerability scanner hack my website?</summary><p>DeployPass does not attempt to break into the website. Its scanner uses passive and low-impact requests to inspect publicly observable responses and configuration signals. It does not perform SQL injection, password attacks, authenticated exploitation, destructive testing, or intrusive penetration-testing techniques.</p></details><details><summary>How often should I scan my website?</summary><p>Run a scan before an important deployment and again after changes that affect hosting, headers, authentication, cookies, CDN rules, redirects, or frontend configuration. Rechecking after a fix is also useful because a change in the application, reverse proxy, CDN, or hosting platform can alter the security signals exposed to browsers.</p></details><details><summary>What is the difference between vulnerability scanning and penetration testing?</summary><p>A scanner automates repeatable checks and quickly highlights known classes of configuration risk. Penetration testing is broader and usually involves a security professional actively testing application logic, authentication, authorization, infrastructure, and exploitability. DeployPass is intentionally on the safe, passive-scanning side of that distinction.</p></details><details><summary>Can I scan a staging website before deployment?</summary><p>Yes, if the staging URL is publicly reachable from the internet. Private localhost addresses, internal network hosts, and protected staging environments cannot be inspected by a public scanner. For a public preview deployment, scanning before production can catch browser-facing configuration problems early.</p></details><details><summary>Can this scanner find every website vulnerability?</summary><p>No scanner can guarantee that. DeployPass does not claim to discover every application, server, dependency, or business-logic vulnerability. It is designed to surface common public-facing security and deployment issues quickly. High-risk applications should also use code review, dependency scanning, authenticated testing, and professional penetration testing where appropriate.</p></details><details><summary>What should I do after the scan finds a warning?</summary><p>Read the finding and verify whether it applies to your application. Fix the relevant application, CDN, reverse-proxy, or hosting configuration, deploy the change, and scan again. Use the focused DeployPass checkers for headers, HSTS, CSP, CORS, mixed content, and Permissions Policy when you need a narrower diagnostic view.</p></details></div></section>

<section class="section"><div class="wrap"><span class="eyebrow">RELATED SECURITY TOOLS</span><h2>Investigate a finding in more detail</h2><div class="cards">
<article><h3><a href="/security-headers-checker">Security Headers Checker →</a></h3><p>Inspect the browser security headers returned by a public URL.</p></article>
<article><h3><a href="/hsts-checker">HSTS Checker →</a></h3><p>Check Strict-Transport-Security and HTTPS enforcement signals.</p></article>
<article><h3><a href="/csp-checker">CSP Checker →</a></h3><p>Review a Content Security Policy and common configuration gaps.</p></article>
<article><h3><a href="/cors-checker">CORS Checker →</a></h3><p>Inspect cross-origin response behavior and credential-related settings.</p></article>
<article><h3><a href="/mixed-content-checker">Mixed Content Checker →</a></h3><p>Find insecure HTTP resources referenced by an HTTPS page.</p></article>
<article><h3><a href="/permissions-policy-checker">Permissions Policy Checker →</a></h3><p>Review browser feature permissions exposed by the site.</p></article>
</div></div></section>

<footer><div class="wrap foot"><span>© DeployPass · Passive checks for safer deployments.</span><span><a href="/">Home</a> · <a href="/deployment-security-check">Deployment Check</a></span></div></footer>
...
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a><span>© 2026 DeployPass · Public-surface deployment security checks.</span><a href="/">Full scan →</a></div></footer>
<script>
...
<path d="M18 15h15.5C45 15 52 21.6 52 32S45 49 33.5 49H18V15Zm10 9v16h6c5.7 0 9.1-2.8 9.1-8S39.7 24 34 24h-6Z" fill="#fff"/>
<path d="m29 32 4.1 4.2 8.9-10.4" fill="none" stroke="#86efac" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
</svg><span>Deploy<span class="dp-accent">Pass</span></span></a><span>© 2026 DeployPass · Public-surface deployment security checks.</span><span><a href="/security-headers-checker">Security Headers</a> · <a href="/mixed-content-checker">Mixed Content</a> · <a href="/">Full scan</a></span></div></footer>
<script>
const esc=s=>String(s==null?'':s).replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
...
async function mixedContentCheck(target){
  ...
  return {ok:true,target:finalUrl.toString(),pageHttps:finalUrl.protocol==='https:',totalResources:unique.length,insecureCount:issues.length,activeCount,passiveCount,score,verdict,issues:issues.slice(0,50),truncated:sample.truncated};
    ...
    if (url.pathname === "/deployment-security-check" || url.pathname === "/deployment-security-check/") {
      return new Response(DEPLOYMENT_SECURITY_HTML, {headers:{"content-type":"text/html; charset=utf-8","cache-control":"public, max-age=300","x-content-type-options":"nosniff","referrer-policy":"strict-origin-when-cross-origin"}});
    }
